<template>
  <ion-page>
    ...
    <ion-content class="template-content">
      <ion-grid>
        <ion-row class="container ion-justify-content-center ion-align-items-center">
          <ion-card class="auth-card">
            <ion-card-header class="auth-headers">
              <ion-card-title color="light" class="ion-text-center ion-margin-bottom">
                <h1>Bank One</h1>
              </ion-card-title>
              <ion-card-subtitle color="light-tint" class="ion-text-capitalize ion-text-center ion-margin-bottom">
            ...
            <ion-card-content>
              <form>
                <ion-grid>
                  <div>
                    <ion-input v-model="lastName" class="custom ion-margin-bottom" type="text" name="credentials.lastName"
                      placeholder="Last name" :clear-on-edit="true"></ion-input>
                    <div class="errorMsg">
                      <ion-text color="danger">{{
                        errors["credentials.lastName"]
                      }}</ion-text>
                    </div>
                    <ion-input v-model="firstName" class="custom ion-margin-bottom" type="text"
                      name="credentials.firstName" placeholder="First name" :clear-on-edit="true"></ion-input>
                  </div>
                  <div class="errorMsg">
                    <ion-text color="danger">{{
                  ...
                  <ion-input v-model="birthDate" class="custom ion-margin-bottom" type="date" name="credentials.birthDate"
                    placeholder="Date of birth" :clear-on-edit="true"></ion-input>
                  <div class="errorMsg">
                    <ion-text color="danger">{{
                      errors["credentials.birthDate"]
                    }}</ion-text>
                  </div>
                  <ion-input v-model="email" class="custom ion-margin-bottom" type="email" name="credentials.email"
                    placeholder="Email" :clear-on-edit="true"></ion-input>
                  <div class="errorMsg">
                    <ion-text color="danger">{{
                  ...
                  <ion-input v-model="password" class="custom ion-margin-bottom" type="password"
                    name="credentials.password" placeholder="Password" :clear-on-edit="true"></ion-input>
                  <div class="errorMsg">
                    <ion-text color="danger">{{
                      errors["credentials.password"]
                    }}</ion-text>
                  </div>
                  <ion-input v-model="confirmPassword" class="custom ion-margin-bottom" type="password"
                    name="credentials.confirmPassword" placeholder="Confirm Password" :clear-on-edit="true"></ion-input>
                  <div class="errorMsg">
                    <ion-text color="danger">{{
                  ...
                  <!-- <ion-input v-model="currency" class="custom ion-margin-bottom" type="text" name="credentials.currency"
                    placeholder="Preferred Currency" :clear-on-edit="true"></ion-input> -->
                  <div class="errorMsg"> 
                    <ion-text color="danger">{{
                      errors["credentials.currency"]
                    }}</ion-text>
                  </div>

                  <ion-item>
                    <ion-checkbox slot="start" name="credentials.tos" :value="false" @ionChange="showCred"></ion-checkbox>
                    <ion-label>
                  ...
                  <ion-button class="custom ion-margin-bottom ion-margin-top" type="button" color="tertiary"
                    expand="block" @click.prevent="sendRegister">Sign up</ion-button>
                </ion-grid>
              </form>
...
const enumCurrencies = ["EURO", "DOLLAR", "POUND"];
...
const credentialsComponentSchema = yup
  .object({
    credentials: yup.object({
      ...
      currency: yup.string().oneOf(enumCurrencies, "Invalid currency")
        .required("You need to specify a currency"),
...
export default defineComponent({
  ...
  setup() {
    ...
    const { value: currency } = useField("credentials.currency");
    ...
    const clearCredentials = () => {
      ...
      registerForm.values.credentials.currency = "";
